package com.example.wifi_scaner_l2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scanlist.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String lvl;
                if(temp.level<=-70) lvl="Слабый";
                else if(temp.level<=-60) lvl="Средний";
                else if(temp.level<=-50) lvl="Сильный";
                else lvl="Excellent";
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                builder.setTitle("Информация")
                        .setMessage(" SSID - " +temp.SSID+"\n"+ " BSSID - "+temp.BSSID+"\n"+" Уровень сигнала - " + lvl+"  Технологии - "+temp.capabilities+"\n"+" Частота - "+temp.frequency+" MHz\n" +"\n" )
                        .setCancelable(false)
